...
Twat.prototype = {
    ...
    get: function(url, params, callback) {
        ...
        this.oauth.get(url + '?' + querystring.stringify(params), this.options.access_token_key, this.options.access_token_secret, function(error, data, response) {
 ...
 * POST
 */
Twat.prototype.post = function(url, content, content_type, callback) {
    ...
    this.oauth.post(url, this.options.access_token_key, this.options.access_token_secret, content, content_type, function(error, data, response) {
        if (error && error.statusCode) {
 ...
 */
Twat.prototype.search = function(q, params, callback) {
    if (typeof params === 'function') {
        callback = params;
        params = {};
    }
...
Twat.prototype.stream = function(method, params, callback) {
    ...
    url, this.options.access_token_key, this.options.access_token_secret, params, null);
